    ...
    $.fn.modal= function(options){
        ...
        function openModal(){
            ...
            modals.hide();
            currentModal.css({
                top:$(window).height() /8 - currentModal.outerHeight() /8 + $(window).scrollTop(),
                left:$(window).width() /14 - currentModal.outerWidth() /14 + $(window).scrollLeft()
            });
        ...
        function moveModal(){
            ...
            .stop(true)
            .animate({
            top:$(window).height() /8 - modals.outerHeight() /8 + $(window).scrollTop(),
            left:$(window).width() /14 - modals.outerWidth() /14 + $(window).scrollLeft()
