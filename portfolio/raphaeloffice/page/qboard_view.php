...
<table cellpadding="0" cellspacing="0" class="table01" style="width:650px;">
	...
	<tr>
		<td colspan="6" style="text-align:center; padding:7px;">
			...
			<input type="button" class="button00" value="수정" title="수정" onclick="location.href='sub.php<?php echo PAGE; ?>&amp;qa_board=qboard_password&amp;no=<?php echo $data[no]; ?>'" />&nbsp;
			<input type="button" class="button00" value="삭제" title="삭제" onclick="location.href='sub.php<?php echo PAGE; ?>&amp;qa_board=qboard_password_2&amp;no=<?php echo $data[no]; ?>'" />&nbsp;
			...
			<input type="button" class="button02" value="추천" title="추천" onclick="location.href='sub.php<?php echo PAGE; ?>&amp;qa_board=qboard_famous&amp;no=<?php echo $data[no]; ?>'" />
		</td>
	</tr>
</table>