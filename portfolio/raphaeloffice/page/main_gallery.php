...
<table width="200" height="73" style="margin:45px 0 0 4px;">
  <tr>
    <td><A HREF="javascript:prev()"><img src="./images/main_left.png" alt="����" style="margin:0 8px 0 7px;" /></A></td>
    ...
    <td><A HREF="javascript:next()"><img src="./images/main_right.png" alt="����" style="margin:0 0px 0 8px;" /></A></td>
  </tr>
</table>
