...
<table cellpadding="0" cellspacing="0" class="table00">
	...
	<tr>
		...
		<td class="table00_td"><span class="board_view"><a href="sub.php<?php echo PAGE; ?>&amp;board=board_view&amp;no=<?php echo $data[no]; ?>"><?php echo $data[subject]; ?></a></span></td>
	...
	<tr>
		<td colspan="6" style="text-align:right; padding:7px 5px 7px 7px;">
			<input type="button" class="button00" value="글쓰기" onclick="location.href='sub.php<?php echo PAGE; ?>&amp;board=board_write'" />
		</td>
	</tr>
</table>
