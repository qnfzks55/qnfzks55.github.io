...
?>
<!-- �Խ��� ����-->
<form action="board_modify_ok.php<?php echo PAGE; ?>&amp;no=<?php echo $_GET[no]; ?>" method="post" id="chk" onsubmit="return chk()" enctype="multipart/form-data">
	<table cellpadding="0" cellspacing="0" class="table01">
		...
		<tr>
			...
			<td class="table01_td">
				<textarea name="contents" id="contents" title="����" cols="" rows="" class="input01" style="height:250px; font-family:����;"><?php echo $data[contents]; ?></textarea>
			</td>
		</tr>
		<tr>
		...
		<tr>
			...
			<td class="table01_td">
				<input type="password" name="password" id="password" title="�н�����" class="input02" />
			</td>
		</tr>
		<tr>
