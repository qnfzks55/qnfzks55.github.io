...
function chk(){
	...
	if(!chkblank(a.password, "��й�ȣ�� �Է� �� �ּ���.")){ return false; }
...
<!-- �Խ��� �۾���-->
<form action="board_write_ok.php<?php echo PAGE; ?>" method="post" id="chk" onsubmit="return chk()" enctype="multipart/form-data">
...
<input type="hidden" name="sub_id" value="<?php echo $_GET[sub_id]; ?>" />
	<table cellpadding="0" cellspacing="0" class="table01">
		...
		<tr>
			...
			<td class="table01_td">
				<textarea name="contents" id="contents" title="����" cols="" rows="" class="input01" style="height:250px; font-family:����;"></textarea>
			</td>
		</tr>
		<tr>
