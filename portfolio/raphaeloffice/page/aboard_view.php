...
<table cellpadding="0" cellspacing="0" class="table01" style="width:650px;">
	<tr style="background:#f7f7f7;">
		...
		<td class="table01_td"><?php echo $data[subject]; ?></td>
	...
	<tr>
		<td colspan="6" style="text-align:center; padding:7px;">
			...
			<input type="button" class="button00" value="수정" title="수정" onclick="location.href='sub.php<?php echo PAGE; ?>&amp;qa_board=aboard_password&amp;no=<?php echo $data[no]; ?>'" />&nbsp;
			<input type="button" class="button00" value="삭제" title="삭제" onclick="location.href='sub.php<?php echo PAGE; ?>&amp;qa_board=aboard_password_2&amp;no=<?php echo $data[no]; ?>'" />&nbsp;
			<input type="button" class="button00" value="답변" title="답변" onclick="location.href='sub.php<?php echo PAGE; ?>&amp;qa_board=aboard_write&amp;no=<?php echo $data[no]; ?>'" />&nbsp;
			<input type="button" class="button02" value="추천" title="추천" onclick="location.href='sub.php<?php echo PAGE; ?>&amp;qa_board=aboard_famous&amp;no=<?php echo $data[no]; ?>'" />
		</td>
	</tr>
</table>