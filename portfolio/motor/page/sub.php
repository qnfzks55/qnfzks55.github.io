...
?>
<title>원동기 - <?php if($data){ echo $data[main_title]; }else{ echo "서브페이지"; } ?> - <?php if($mdata){ echo $mdata[sub_title]; }else{ echo "서브페이지"; }?></title>
	...
	<div id="sub_top"><!-- Top Area -->
		<div id="sub_top_navi"><!-- Navigation Area -->
			...
			<div id="logo_area"><!-- Logo Style -->
				<div id="logo_style">
					<a href="index.php">
						<img src="../images/sub_logo.jpg" width="238" height="80" alt="원동기" />
					</a>
				</div>
			</div>
