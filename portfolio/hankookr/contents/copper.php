...
<div style="width:336px; float:left;">
	...
	<div style="width:328px; margin-left:25px;">
		<div class="font_h">수거가능한 폐전선의 종류 </div>
		<div class="font_h">전력케이블(IV,EV류) 통신케이블, 전자/자동차 비선, 고무및</div>
		<div class="font_h"> 합성 pvc선 동축 케이블선 등 </div>
	</div><br />
	<div style="float:right; margin:10px 34px 0 0;"><img src="../image/disuse_img8.jpg" /></div>
</div>